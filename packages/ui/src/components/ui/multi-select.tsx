...
interface MultiSelectProps
   ...
   * Useful for implementing async search or server-side filtering.
   * Optional, if not provided, search will work with local filtering only.
   */
...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
  (
    ...
    const filteredOptions = React.useMemo(() => {
      // If onSearchChange is provided, don't filter locally - let parent handle it
      if (onSearchChange) {
        return options;
      }
