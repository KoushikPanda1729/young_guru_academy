...
import { CallType } from "../helpers/call.schema";

type Action = "export";

interface CallsTableActionBarProps {
  table: Table<CallType>;
}

export function CallsTableActionBar({ table }: CallsTableActionBarProps) {
